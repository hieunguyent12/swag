...
import (
	...
	"github.com/hieunguyent12/swag/v2"
)
...
func TestGen_BuildDescriptionWithQuotes(t *testing.T) {
	...
	cmd := exec.Command("go", "build", "-buildmode=plugin", "github.com/hieunguyent12/swag/v2/testdata/quotes")
...
func TestGen_BuildDocCustomDelims(t *testing.T) {
	...
	cmd := exec.Command("go", "build", "-buildmode=plugin", "github.com/hieunguyent12/swag/v2/testdata/delims")
