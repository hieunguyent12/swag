...
import (
	myv1 "github.com/hieunguyent12/swag/v2/testdata/generics_package_alias/internal/path1/v1"
	myv2 "github.com/hieunguyent12/swag/v2/testdata/generics_package_alias/internal/path2/v1"
)
